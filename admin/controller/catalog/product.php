...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if(!isset($this->request->post['meta_title']) || $this->request->post['meta_title']==''){
			foreach ($this->request->post['product_description']??[] as $key=>$val){
				if(!isset($this->request->post['product_description'][$key]['meta_title']) || trim($this->request->post['product_description'][$key]['meta_title'])==''){
					$this->request->post['product_description'][$key]['meta_title'] = $val['name'];
				}
				
				if(!isset($this->request->post['product_description'][$key]['meta_description']) || trim($this->request->post['product_description'][$key]['meta_description'])==''){
					$this->request->post['product_description'][$key]['meta_description'] = preg_replace('/[\n\r\s]+/', ' ', strip_tags(htmlspecialchars_decode($val['description'])));
				}
			}
		}
		//TODO SEO END
